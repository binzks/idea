    ...
    function(b, c, d) { (function() {
            ...
            j = (function(o) {
                ...
                n.prototype.defaultOptions = {
                    ...
                    dictFileTooBig: "文件过大({{filesize}}MB).请上传{{maxFilesize}}MB以内的图片.",
                    dictInvalidFileType: "You can't upload files of this type.",
                    dictResponseError: "Server responded with {{statusCode}} code.",
                    dictCancelUpload: "删除文件",
                    ...
                    addedfile: function(q) {
                        ...
                        if (this.options.addRemoveLinks) {
                            q._removeLink = n.createElement('<a class="dz-remove" href="javascript:;">' + this.options.dictRemoveFile + "</a>");
